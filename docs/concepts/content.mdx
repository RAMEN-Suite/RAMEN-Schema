...
<Figure
  id="fig:content-plain-text"
  number="2"
  src="/images/concepts/content-plain-text.png"
...
<Figure
  id="fig:content-image"
  number="3"
  src="/images/concepts/content-image.png"
...
<Figure
  id="fig:content-typed-annotation"
  number="4"
  src="/images/concepts/content-typed-annotation.png"
...
:::tip
Refined annotation nodes are useful when an annotation kind **should become a distinct project-specific concept** in the model. In many cases, however, `type`-based annotations are sufficient and keep the annotation model _simple_.
:::
...
<Figure
  id="fig:content-refers-entity"
  number="5"
  src="/images/concepts/content-refers-entity.png"
...
<Figure
  id="fig:content-tei-convert"
  number="6"
  src="/images/concepts/content-tei-convert.png"
...
<Figure
  id="fig:content-atag"
  number="7"
  src="/images/concepts/content-atag.png"
...
In this pattern, the RAMEN `Content` node remains the **content-bearing entry point** for the project model. The ATAG structure provides a more detailed internal representation of the text. Relations such as `STANDOFF_START` and `STANDOFF_END` belong to this granular text serialisation, while RAMEN tools can still rely on the `Content` node and `HAS_ANNOTATION` relation at the model level.
